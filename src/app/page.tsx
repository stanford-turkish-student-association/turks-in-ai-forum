      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container py-24 sm:py-28 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base sm:text-lg text-gray-700 dark:text-gray-300 mb-8">
            The Stanford Turks in AI Forum will bring together researchers, entrepreneurs, and investors to empower the Turkish AI ecosystem. Organized by the <strong><a className="underline underline-offset-4" href="https://www.linkedin.com/company/stanford-turkish-student-association/about/" target="_blank" rel="noopener noreferrer">Stanford Turkish Student Association</a></strong>, this landmark gathering will serve as a platform to elevate the ecosystem, foster collaboration, and highlight the success stories of Türkiye’s AI community on the global stage. We would like to thank all supporters who helped bring this forum to life, especially <a className="underline underline-offset-4" href="https://globalturksai.org/" target="_blank" rel="noopener noreferrer">Global Turks in AI</a>.
          </p>
